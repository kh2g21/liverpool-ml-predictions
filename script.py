...
mse_liverpool_goals = mean_squared_error(y_liverpool, pred_liverpool_goals)
print(f"MSE for Liverpool predicted goals: {mse_liverpool_goals}")

# Calculate MSE for opponent goals
mse_opponent_goals = mean_squared_error(y_opponent, pred_opponent_goals)
print(f"MSE for opponent predicted goals: {mse_opponent_goals}")
